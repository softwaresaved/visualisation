...
python aggregate_data.py sum data/sheets/filtered/consultancy.csv "Project Name" "PMs" "Project" "PMs" data/sheets/filtered/project_effort.csv

# Chart-FunderEffort tab
# Header assumed to include:
# Funder, Effort
wget --no-check-certificate --output-document=data/sheets/as-is/funders_effort.csv "https://docs.google.com/spreadsheets/d/${SHEET_ID}/export?gid=1949517833&format=csv"

# Chart-Funding tab
# Header assumed to include:
# Funder, Projects
wget --no-check-certificate --output-document=data/sheets/as-is/funders_project.csv "https://docs.google.com/spreadsheets/d/${SHEET_ID}/export?gid=7&format=csv"
